...
The application example first demonstrates the various debug system service macros. It then demonstrates the console related APIs. The application asks the user to enter a character on the console which is echoed back using the console system service read/write APIs.
