...
title: USART driver synchronous mode single device
has_children: false
has_toc: false
---
...
# USART driver synchronous mode single device
...
| ----------------- | ---------------------------------------------- |
| pic32cm_mc00_curiosity_pro_freertos.X | MPLABX project for [PIC32CM MC00 Curiosity Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/) |
|||
...
| Project Name| Board|
|:---------|:---------:|
| pic32cm_mc00_curiosity_pro_freertos.X | [PIC32CM MC00 Curiosity Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/) |
|||
